    ...
    <div className="w-full h-screen lg:flex justify-center items-center ">
      <div className="flex justify-center items-center sm:flex-col sm:gap-5 sm:mt-4">
        <div className="lg:flex flex-col sm:flex items-center gap-3">
          <img src={Logo} alt="Logo" className="pt-20" />
          <h1 className="font-semibold text-2xl">Place N'Go</h1>
          <p className="w-[35%] sm:w-[70%] font-normal text-xl leading-8 xlg:leading-5 xlg:text-base">
        ...
        <div className="gap-4 lg:flex xlg:gap-1 sm:hidden">
          <div>
