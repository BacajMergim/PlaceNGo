...
function ContactUsPage() {
  return (
    <div className="flex flex-col lg:flex-row justify-between ml-28 my-5 h-screen w-full gap-5 sm:ml-7 mt-8 sm:h-full overflow-y-scroll overflow-x-hidden text-center pb-28">
      <Card style={"!bg-opacity-10"}>
        <div className="flex flex-col justify-between h-full">
          ...
          <p className="text-sm font-medium">E-Mail: TischZeit@gmail.com</p>
        </div>
      </Card>
      <Card style={"!bg-opacity-25 lg:mt-[108px] !p-0"}>
        <div className="flex flex-col justify-between h-[400px] rounded-md  w-full !overflow-hidden">
          <Map />
        </div>
      </Card>
      <Card style={"!bg-opacity-30 lg:mt-[238px] !p-2"}>
        <div className="flex flex-col justify-between h-full ">
          <h3 className="text-black text-center text-lg font-bold">Über uns</h3>
          <p className="text-black">
            Bei TischZeit stehen Qualität, Tradition und Professionalität im
      ...
      <Card style={"!bg-opacity-40 lg:mt-[368px] !p-0 mb-28"}>
